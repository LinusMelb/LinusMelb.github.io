...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body class="topic" style="">

        <div class="container-fluid">

            <!-- Slider -->
            <div class="tp-banner-container" style="overflow: visible;">
                <div class="tp-banner revslider-initialised tp-simpleresponsive" id="revslider-211" style="max-height: 278px; height: 278px;">
            ...
            <div class="headernav">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-1 col-xs-3 col-sm-2 col-md-2 logo "><a href="mg src="/packages/linus/forum/assets/img/logo.jpg" alt=""></a></div>
                        ...
                        <div class="col-lg-4 col-xs-12 col-sm-5 col-md-4 avt">
                            <div class="stnt pull-left">                            
                                <form action="tml" method="post" class="form">
                            ...
                            <div class="avatar pull-left dropdown">
                                <a data-toggle="dropdown" href=""><img src="/packages/linus/forum/assets/img/avatar.jpg" alt=""></a> <b class="caret"></b>
                                <div class="status green">&nbsp;</div>
                                <ul class="dropdown-menu" role="menu">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="">My Profile</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-2" href="">Inbox</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-3" href="">Log Out</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-4" href=".html">Create account</a></li>
                                </ul>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 breadcrumbf">
                            <a href="">Borderlands 2</a> <span class="diviver">&gt;</span> 

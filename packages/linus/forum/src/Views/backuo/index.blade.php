    ...
    <body style="">
        ...
        <div class="container-fluid">
            ...
            <div class="tp-banner-container" style="overflow: visible;">
                <div class="tp-banner revslider-initialised tp-simpleresponsive" id="revslider-986" style="max-height: 278px; height: 278px;">
            ...
            <div class="headernav">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-1 col-xs-3 col-sm-2 col-md-2 logo"><a href="><img src="/packages/linus/forum/assets/img/logo.jpg" alt=""></a></div>
                        <div class="col-lg-3 col-xs-9 col-sm-5 col-md-3 selecttopic">
                            <div class="dropdown">
                                <a data-toggle="dropdown" href="">Borderlands</a> <b class="caret"></b>
                        ...
                        <div class="col-lg-4 col-xs-12 col-sm-5 col-md-4 avt">
                            <div class="stnt pull-left">                            
                                <form action="c.html" method="post" class="form">
                                    <a href="/NewTopic" class="btn btn-primary">Start New Topic</a>
                                </form>
                            </div>
                            <div class="env pull-left"><i class="fa fa-envelope"></i></div>

                            <div class="avatar pull-left dropdown">
                                <a data-toggle="dropdown" href=""><img style="width: 40px; height: 40px;top:10px; left:10px; border-radius: 50%;" src="/packages/linus/forum/assets/img/avatars/speaker-1.png" alt=""></a> <b class="caret"></b>
                                <div class="status green">&nbsp;</div>
                                <ul class="dropdown-menu" role="menu">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="">My Profile</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-2" href="">Inbox</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-3" href="">Log Out</a></li>
                                    <li role="presentation"><a role="menuitem" tabindex="-4" href="unt.html">Create account</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-8 col-md-8">
                            ...
                            <div class="post">
                                <div class="wrap-ut pull-left">
                                    <div class="userinfo pull-left">
                                        <div class="avatar">
                                            <img src="/packages/linus/forum/assets/img/avatar.jpg" alt="">
                                            <div class="status green">&nbsp;</div>
                                        </div>
                            ...
                            <div class="post">
                                <div class="wrap-ut pull-left">
                                    <div class="userinfo pull-left">
                                        <div class="avatar">
                                            <img src="/packages/linus/forum/assets/img/avatar2.jpg" alt="">
                                    ...
                                    <div class="posttext pull-left">
                                        <h2><a href="ml">What Instagram Ads Will Look Like</a></h2>
                            ...
                            <div class="post">
                                <div class="wrap-ut pull-left">
                                    <div class="userinfo pull-left">
                                        ...
                                        <div class="icons">
                                            <img src="/packages/linus/forum/assets/img/icon2.jpg" alt=""><img src="/packages/linus/forum/assets/img/icon4.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="posttext pull-left">
                                        <h2><a href="ml">The Future of Magazines Is on Tablets</a></h2>
                            ...
                            <div class="post">
                                <div class="wrap-ut pull-left">
                                    <div class="userinfo pull-left">
                                        <div class="avatar">
                                            <img src="/packages/linus/forum/assets/img/avatar4.jpg" alt="">
                                            <div class="status yellow">&nbsp;</div>
                                        </div>

                                        <div class="icons">
                                            <img src="/packages/linus/forum/assets/img/icon1.jpg" alt=""><img src="/packages/linus/forum/assets/img/icon4.jpg" alt=""><img src="/packages/linus/forum/assets/img/icon6.jpg" alt="">
                                        </div>
                                    </div>
                                    <div class="posttext pull-left">
                                        <h2><a href="ml">Pinterest Now Worth $3.8 Billion</a></h2>
                            ...
                            <div class="post">
                                <div class="wrap-ut pull-left">
                                    ...
                                    <div class="posttext pull-left">
                                        <h2><a href="ml">10 Kids Unaware of Their Halloween Costume</a></h2>
                                        <p>It's one thing to subject yourself to a Halloween costume mishap because, hey, that's your prerogative.</p>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
            ...
            <footer>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-1 col-xs-3 col-sm-2 logo "><a href=""><img src="/packages/linus/forum/assets/img/logo.jpg" alt=""></a></div>
                        <div class="col-lg-8 col-xs-9 col-sm-5 ">Copyrights 2017, Sunrise.com</div>

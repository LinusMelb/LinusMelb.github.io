                        ...
                        <!-- Added manually -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="gender"
                                       ...
                                       value="@if(isset($dataTypeContent->gender)){{ old('gender', $dataTypeContent->gender) }}@else{{old('gender')}}@endif">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if(isset($dataTypeContent->avatar))
                                    <img src="{{ $dataTypeContent->avatar }}"
                                         style="width:40px; height:40px; clear:both; display:block; padding:2px; border:1px solid #ddd; margin-bottom:10px;">
                                @endif
                                <select name="avatar">
                                    <option value="/storage/avatars/default-M.png">Male</option>

                                    <option value="/storage/avatars/default-F.png">Female</option>
                                </select>
                            </div>

...
+function ($) {
	...
	Confirmation.DEFAULTS = $.extend({}, $.fn.popover.Constructor.DEFAULTS, {
		...
		onConfirm 		: function(event, element){
												var discussionID = $('#discussion').attr('data-value');
												var commentID = element[0].attributes[1]['nodeValue'];
												/* Delete Comment here via AJAX */
												/* Decrease # of answers in current discussion by 1*/
											  $.ajax({
											      url: '/comments/delete/' + discussionID + '/' + commentID,
											      type:'post',
											      processData: false,
											      contentType: false,
		...
		template 		:   '<div class="popover"><div class="arrow"></div>'
							...
							+ '<a data-dismiss="confirmation" style="margin-left: 5px;">No</a>'
							+ '</div>'
							+ '</div>'
	});
